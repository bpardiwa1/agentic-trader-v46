# ============================================================
# Agentic Trader v4.6 — XAUUSD Indicator Engine
# ------------------------------------------------------------
# Purpose:
#   • Compute EMA fast/slow, RSI, and ATR for XAUUSD.
#   • Output dict used by xau_decider_v46.
# ============================================================
...
def compute_features(bars: pd.DataFrame,
    ...
    """
    Compute indicators and derived features for XAUUSD.
